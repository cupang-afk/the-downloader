"""Wget-based download provider implementation."""
...
class WgetDownloader(DownloadSubprocessProvider):
    """Download provider using the wget binary.

    This provider downloads files using HTTP/HTTPS with wget,
    ...
    def download(
        ...
        cmd_headers = [f'--header="{x}: {y}"' for x, y in task.headers.items()]
